function check(user_input) {
    ...
    functions[0] = (x, y) => {
      ...
      if(should_print) {
        //console.log("getNestedValue(" + a +", " + b +") --> " + b[a])
      }
      
      if (should_z3_print) {
        if(a === "length") {
          // console.log("array_"+i2+".length = " + b[a])
        }
        else if (i2 === 0)
          console.log("password["+a+"] = " + b[a])
        else
          console.log("array_"+i2+"["+a+"] = " + b[a])
      }
      
      return b[a]
    }
    functions[1] = (x, y) => {
        // var temp = y[x.pop()].charCodeAt(0);
        
        // if(should_print) console.log("getCharCode --> " + temp)
    ...
    functions[2] = (x, y) => {
        ...
        if(should_print) console.log("!" + temp + " = " + !temp)
        
        if(should_z3_print) console.log("!" + temp + " = " + !temp)
    ...
    functions[3] = (x, y) => {
        ...
        if(should_print) console.log(b + " % " + a + " = " + skibidi)
    ...
    functions[4] = (x, y) => {
        ...
        if(should_print) console.log(temp1 + " * " + temp2 + " = " + temp1*temp2)
        
        if(should_z3_print) console.log(temp1 + " * " + temp2 + " = " + temp1*temp2)
    ...
    functions[5] = (x, y) => {
        var temp1 = y[x.pop()];
        var temp2 = y[x.pop()];
        if(should_print) console.log(1 + " / (" + temp1 + " / " + temp2 + ") = " + (1 / (temp1 / temp2)))
      
        if(should_z3_print) console.log(1 + " / (" + temp1 + " / " + temp2 + ") = " + (1 / (temp1 / temp2)))
    ...
    functions[6] = (x, y) => {
        ...
        // console.log("addWithoutCarry(" + a + ", " + b + ") = " + result)
        if(should_print) console.log(a + " + " + b + " = " + result)
        
        if(should_z3_print) console.log(a + " + " + b + " = " + result)
    ...
    functions[7] = (x, y) => {
        ...
        // console.log("subtractWithoutCarry(" + a + ", " + b + ") = " + result)
        if(should_print) console.log(a + " - " + b + " = " + result)
    ...
    functions[8] = (x, y) => {
        ...
        // if (temp1 === 1410273) console.log(temp1 + " === " + temp2)
    ...
    // print func count
    func_count.forEach((i, j) => {console.log("function"+j +": " + i)})
...
for (let i = 0; i <= 0; i++) {
  // Godtyckligt mög med längd 38
  var password = [00, 11, 22, 33, 44, 55, 66, 77, 88, 99,
                  00, 11, 22, 33, 44, 55, 66, 77, 88, 99,
                  00, 11, 22, 33, 44, 55, 66, 77, 88, 99,
                  00, 11, 22, 33, 44, 55, 66, 77]
  var res = check([password, [252, 174, 221, 116, 74, 140, 110, 29], [166, 74, 96, 96, 218, 220, 56, 111]])
